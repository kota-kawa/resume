...
- **Intern (2 months)**: Collaborated closely with teachers and product teams to carefully develop a RAG-based chat system, collecting frontline feedback to iteratively refine requirements, data structuring, prompt design, and response quality while maintaining privacy and usability.
...
- **インターン（2か月）**: 教職員やプロダクトチームと密に連携し、現場の声を丁寧に聞きながらRAGベースのチャットシステムを共同開発。要件定義、データ構造化、プロンプト設計、応答品質の改善を反復的に行い、プライバシーと使いやすさを両立させた。
